...
def fig_11_2():
    ...
    plt.tight_layout()
    plt.savefig('excercise11_3/figures/ch10_fig_11_2.png')
    plt.close()
...
def fig_11_6():
    ...
    plt.tight_layout()
    plt.savefig('excercise11_3/figures/ch10_fig_11_6.png')
    plt.close()
...
def fig_11_7():
    ...
    plt.savefig('excercise11_3/figures/ch10_fig_11_7.png')
    plt.close()
